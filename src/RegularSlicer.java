 ...
 * A regular slicer.
 */
public class RegularSlicer extends Sprite {
    ...
    private static final String slicerType = "slicer";
     ...
     */
    public RegularSlicer(List<Point> polyline, int sN, int wN) {
...
//    public void setSpawnNumber(int sN) {
//        spawnNumber = sN;
//    }
