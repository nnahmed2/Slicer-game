...
public class SuperSlicer extends Sprite {
    ...
    private static String slicerType = "superslicer";
     ...
     * @param sN spawn number of slicer
     * @param wN wave number of slicer
     */
    public SuperSlicer(List<Point> polyline, int sN, int wN) {
